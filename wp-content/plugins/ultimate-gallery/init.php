...
Plugin URI: http://www.extendyourweb.com/ultimate-video-gallery/
...
$cont=0;
			if($values!="") {
				...
				foreach ($items as &$value) {
					...
					if($imagemain=="" && eregi("youtube", $item[4])) {
						
						
						$imagemain='http://img.youtube.com/vi/'.getYTidultimate($item[4]).'/0.jpg';
					...
					if($auxivideo!="" && $item[3]==1) {
						...
						$textovid.='&amp;video'.($cont-1).'='.$auxivideo.'&amp;image'.($cont-1).'='.$imageultimate.'&amp;title'.($cont-1).'='.$item[0].'&amp;tipo'.($cont-1).'='.$auxtipo.'&amp;description'.($cont-1).'='.$item[1].'&amp;date'.($cont-1).'='.$item[8].'&subtitle'.($cont-1).'='.$item[8].'&amp;imagem'.($cont-1).'='.$imagemain;
...
('Demo version', '".$_REQUEST["width"]."', '".$_REQUEST["height"]."', '10', 'hide', '".$_REQUEST["twidth"]."', '".$_REQUEST["theight"]."', '12', '1', '".$_REQUEST["number_thumbnails"]."', 'ULTIMATE PROt6r4ndPlays video files flv or youtube videos.t6r4ndt6r4nd1t6r4ndhttp://www.youtube.com/watch?v=kBtMJjLVB90t6r4ndt6r4ndt6r4ndkh6gfd57hgg', '0', '', '".$_REQUEST["sizethumbnail"]."', '10', '".$_REQUEST["color1"]."', '".$_REQUEST["color2"]."', '".$_REQUEST["color3"]."', '".$_REQUEST["time"]."', '', '', '".$_REQUEST["op1"]."', '3', 'Arial', '".$_REQUEST["op4"]."', '');";
...
usort($sorter, 'sortByOrder');
    ...
    $cont = $value['cont'];
			...
			if(!$_POST['item'.$cont] || $_POST['operation']!="2") $values.=$_POST['title'.$cont]."t6r4nd".$_POST['description'.$cont]."t6r4nd".$_POST['image'.$cont]."t6r4nd".$_POST['link'.$cont]."t6r4nd".$_POST['video'.$cont]."t6r4nd".$_POST['timage'.$cont]."t6r4nd".$_POST['seo'.$cont]."t6r4nd".$_POST['seol'.$cont]."t6r4nd".$_POST['subtitles'.$cont].""."t6r4nd"."t6r4nd".$_POST['imagem'.$cont]."kh6gfd57hgg";
		...
		if($_POST['operation']=="1") {
			$values.="Title video t6r4nd".""."t6r4nd".""."t6r4nd"."1"."t6r4nd".""."t6r4nd".""."t6r4nd".""."t6r4nd".""."t6r4nd".""."t6r4nd".""."t6r4nd".""."t6r4nd"."kh6gfd57hgg";
