			...
			if($values!="") {
				...
				foreach ($items as &$value) {
					...
					echo '<input name="video'.$cont.'" type="text" value="'.$item[4].'" class="upload'.$id.'" size="70" /> 
					 ...
					 Main image:<br/>
					 <input type="text" name="imagem'.$cont.'" id="imagem'.$cont.'" value="'.$item[10].'" class="upload'.$id.'" size="70"/>
					 ...
					 Description:<br/><textarea name="description'.$cont.'" rows="5" cols="80" id="description'.$cont.'" >'.$item[1].'</textarea><br/>
					  Subtitles:<br/><textarea name="subtitles'.$cont.'" rows="5" cols="80" id="subtitles'.$cont.'" >'.$item[8].'</textarea><br/>
					  
					  <p class="description">
					  Write each subtitle in a different line, the format is as follows:<br/>
					  
					  minute appearance-second appearance-seconds in duration-subtitle text<br/>
					  Sample: 0-30-5-Hello world (minute 0, 30 seconds, duration 5 seconds, subtitle: hello world)
					  </p>
