...
$ff_version = '1.2.7.38 FREE VERSION (build 278)';
$ff_target  = 0;
...
class facileFormsConf {
	...
	public $smtpuser	= '';
	public $smtppass	= '';
	public $smtphost	= 'localhost'; // usually localhost
        ...
        public $ftp_host	= '127.0.0.1'; // the ip or DNS name of the FTP server
	public $ftp_port	= '21';
	public $ftp_user	= '';
	public $ftp_pass	= '';
	public $ftp_root	= ''; // the base folder you get into after FTP login with your regular client
	public $ftp_enable	= 0; // set to 1 to enable the FTP layer
	...
	var $uploads        = '{contentdir}/breezingforms/uploads';   // {ff_uploads} path
	...
	function load()
	{
		...
		$configfile = WP_CONTENT_DIR . DS . 'breezingforms' . DS . 'facileforms.config.php';
