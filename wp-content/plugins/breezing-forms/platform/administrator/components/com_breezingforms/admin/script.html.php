...
{
	public static function edit($option, $pkg, &$row, &$typelist)
	{
...
?>
		...
		<button class="button-secondary" onclick="submitbutton('cancel');"><?php echo htmlentities(BFText::_('COM_BREEZINGFORMS_TOOLBAR_CANCEL'), ENT_QUOTES, 'UTF-8'); ?></button>
			...
			<tr>
				<td></td>
				<td><?php echo BFText::_('COM_BREEZINGFORMS_SCRIPTS_TITLE'); ?>:</td>
				<td>
			...
			<tr>
				<td></td>
				<td><?php echo BFText::_('COM_BREEZINGFORMS_SCRIPTS_PUBLISHED'); ?>:</td>
				<td><?php echo JHTML::_('select.booleanlist', "published", "", $row->published); ?></td>
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td><?php echo BFText::_('COM_BREEZINGFORMS_SCRIPTS_PACKAGE'); ?>:</td>
				<td>
					<input style="width: 100%" type="text" size="30" maxlength="30" id="package" name="package" value="<?php echo $row->package; ?>" class="inputbox"/>
				</td>
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td><?php echo BFText::_('COM_BREEZINGFORMS_SCRIPTS_NAME'); ?>:</td>
				<td>
					<input style="width: 100%" type="text" size="30" maxlength="30" id="name" name="name" value="<?php echo $row->name; ?>" class="inputbox"/>
			...
			<tr>
				<td></td>
				<td><?php echo BFText::_('COM_BREEZINGFORMS_SCRIPTS_TYPE'); ?>:</td>
				<td>
...
?>
				...
				<td align="right" width="50%" nowrap>
                                    ...
                                    <button onclick="submitbutton('copy')" class="button">
                                    <?php echo BFText::_('COM_BREEZINGFORMS_TOOLBAR_COPY');?>
                                    </button>

                                    <button onclick="submitbutton('publish')" class="button">
                                    <?php echo BFText::_('COM_BREEZINGFORMS_TOOLBAR_PUBLISH');?>
                                    </button>

                                    <button onclick="submitbutton('unpublish')" class="button">
...
?>
				<tr class="row<?php echo $k; ?>">
					...
					if ($row->published == "1") {
						?><a href="#" onClick="return listItemTask('cb<?php echo $i; ?>','unpublish')"><img src="<?php echo plugins_url();?>/<?php echo BF_FOLDER;?>/platform/administrator/components/com_breezingforms/images/icons/publish_g.png" alt="+" border="0" /></a><?php
					} else {
						?><a href="#" onClick="return listItemTask('cb<?php echo $i; ?>','publish')"><img src="<?php echo plugins_url();?>/<?php echo BF_FOLDER;?>/platform/administrator/components/com_breezingforms/images/icons/publish_x.png" alt="-" border="0" /></a><?php
					} // if
					?></td>
