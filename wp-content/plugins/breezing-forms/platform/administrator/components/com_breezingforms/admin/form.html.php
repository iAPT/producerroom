...
?>
				<tr class="row<?php echo $k; ?>">
					...
					<td nowrap valign="top" align="left"><?php
						if ($i > 0) {
							?><a href="#" onClick="return listItemTask('cb<?php echo $i; ?>','orderup')"><img src="<?php echo plugins_url();?>/<?php echo BF_FOLDER;?>/platform/administrator/components/com_breezingforms/images/icons/uparrow.png" alt="^" border="0" /></a><?php
						} // if
					?></td>
					<td nowrap valign="top" align="left"><?php
						if ($i < count($rows)-1) {
							?><a href="#" onClick="return listItemTask('cb<?php echo $i; ?>','orderdown')"><img src="<?php echo plugins_url();?>/<?php echo BF_FOLDER;?>/platform/administrator/components/com_breezingforms/images/icons/downarrow.png" alt="v" border="0" /></a><?php
						} // if
					?></td>
