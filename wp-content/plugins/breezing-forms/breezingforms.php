...
if( ( isset($_GET['act']) && $_GET['act'] == 'quickmode' ) || ( isset($_POST['act']) && $_POST['act'] == 'quickmode' ) ){
    add_action('admin_enqueue_scripts', 'breezingforms_add_quickmode_scripts');
}
function breezingforms_add_quickmode_scripts(){
    
    wp_enqueue_style( mt_rand(0, mt_getrandmax()), plugins_url() . '/'.BF_FOLDER.'/platform/administrator/components/com_breezingforms/libraries/jquery/themes/quickmode/quickmode.all.css' );
    wp_enqueue_style( mt_rand(0, mt_getrandmax()), plugins_url() . '/'.BF_FOLDER.'/platform/administrator/components/com_breezingforms/libraries/jquery/jtree/tree_component.css' );
    
    wp_enqueue_script(mt_rand(0, mt_getrandmax()), plugins_url() . '/'.BF_FOLDER.'/platform/administrator/components/com_breezingforms/libraries/jquery/jtree/_lib.js', array(), false, false );
    wp_enqueue_script(mt_rand(0, mt_getrandmax()), plugins_url() . '/'.BF_FOLDER.'/platform/administrator/components/com_breezingforms/libraries/jquery/jtree/tree_component.js', array(), false, false);
    wp_enqueue_script(mt_rand(0, mt_getrandmax()), plugins_url() . '/'.BF_FOLDER.'/platform/administrator/components/com_breezingforms/libraries/jquery/jq-ui.min.js', array(), false, false);
    wp_enqueue_script(mt_rand(0, mt_getrandmax()), plugins_url() . '/'.BF_FOLDER.'/platform/administrator/components/com_breezingforms/libraries/jquery/plugins/base64.js', array(), false, false);
    wp_enqueue_script(mt_rand(0, mt_getrandmax()), plugins_url() . '/'.BF_FOLDER.'/platform/administrator/components/com_breezingforms/libraries/jquery/plugins/json.js', array(), false, false);
    wp_enqueue_script(mt_rand(0, mt_getrandmax()), plugins_url() . '/'.BF_FOLDER.'/platform/administrator/components/com_breezingforms/libraries/jquery/plugins/md5.js', array(), false, false);
    wp_enqueue_script(mt_rand(0, mt_getrandmax()), plugins_url() . '/'.BF_FOLDER.'/platform/administrator/components/com_breezingforms/libraries/jquery/center.js', array(), false, false);
}
...
if( ( isset($_GET['page']) && $_GET['page'] == 'breezingforms' ) || ( isset($_POST['page']) && $_POST['page'] == 'breezingforms' ) ){
    add_action('admin_enqueue_scripts', 'breezingforms_add_admin_scripts');
}
function breezingforms_add_admin_scripts(){
    // scripts
    wp_enqueue_script(mt_rand(0, mt_getrandmax()), plugins_url() . '/'.BF_FOLDER.'/platform/media/system/js/mootools-core.js');
    wp_enqueue_script(mt_rand(0, mt_getrandmax()), plugins_url() . '/'.BF_FOLDER.'/platform/media/system/js/core.js');
    wp_enqueue_script(mt_rand(0, mt_getrandmax()), plugins_url() . '/'.BF_FOLDER.'/platform/media/system/js/mootools-more.js');
    wp_enqueue_script(mt_rand(0, mt_getrandmax()), plugins_url() . '/'.BF_FOLDER.'/platform/media/system/js/modal.js');
    wp_enqueue_script(mt_rand(0, mt_getrandmax()), plugins_url() . '/'.BF_FOLDER.'/platform/media/system/js/tabs.js');
    wp_enqueue_script(mt_rand(0, mt_getrandmax()), plugins_url() . '/'.BF_FOLDER.'/platform/administrator/components/com_breezingforms/admin/areautils.js');
    // styles
    
    wp_enqueue_style( mt_rand(0, mt_getrandmax()), plugins_url() . '/'.BF_FOLDER.'/platform/media/system/css/modal.css' );
    
    if(isset($_REQUEST['task']) && $_REQUEST['task'] == 'editform' && $_REQUEST['act'] == 'editpage' || (isset($_REQUEST['act'])  && $_REQUEST['act'] == 'configuration') ){
       wp_enqueue_style( mt_rand(0, mt_getrandmax()), plugins_url() . '/'.BF_FOLDER.'/platform/administrator/templates/bluestork/css/template.css' );
    }
}
...
function breezingforms_insert_form_button($content){
    $content .= '<a href="#TB_inline?width=450&height=550&inlineId=breezingforms_insert_form" class="thickbox" title="BreezingForms"><img src="'.plugins_url().'/'.BF_FOLDER.'/breezingforms-icon.png" alt="BreezingForms" /></a>';
    return $content;
}
...
function breezingforms_print_scripts() {
	...
	if (!$add_my_script){
        ...
        if($bf_processor != null){
            wp_enqueue_script(mt_rand(0, mt_getrandmax()), plugins_url() . '/'.BF_FOLDER.'/platform/components/com_breezingforms/libraries/jquery/jq.iframeautoheight.js');
        }
