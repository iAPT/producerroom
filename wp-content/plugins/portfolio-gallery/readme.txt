...
Over 481,160 our users who tried Portfolio Gallery, can prove it's great functionality and utility. 
...
= Portfolio gallery demo 3 Gallery / Content Popup =

This portfolio gallery type of view has the following characteristics: It opens each photo from your tape increasing them as popup, with the text and other images/videos inside, next to the main image/video in portfolio gallery. There is also a button “View more” inside, which allows opening more information about the content. In portfolio gallery the “cross” button in the upper right corner closes the popup going back to the tape.

= Portfolio gallery demo 4 Full-Width Block =

Portfolio gallery this type of view looks like already opened popup. It allows to see your main image with its additional images under it and the text disposed next to the image. The title is above the text and “View more” button is at the bottom of the text. Gallery all the images opens and becomes larger with lightbox.

= Portfolio gallery demo 5 FAQ Toggle Up/Down =

Portfolio gallery FAQ Toggle view is very simple. You can see only the titles and down-arrow button. Portfolio gallery Clicking on down-arrow button smoothly opens the text downwards and “view more” button under it. So there are no images/videos only the text. Pressing on the cross you can close the text and go back to titles.

= Portfolio gallery demo 6 Content Slider =

Gallery this type of view gives you an ability to see photos with slider, the text is next to the image / video with the title above. Portfolio gallery just simply press the arrows on the upper right corner and slide the content.

= Portfolio gallery demo 7 Lightbox Gallery =

This gallery view involves only review of images without text. Portfolio gallery title comes up from the bottom of the image as you hover the mouse on it. Images become larger with the lightbox and you can slide to watch them.
